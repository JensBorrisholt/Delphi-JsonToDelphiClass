unit JsonToDelphi.Runtime.StubField;

interface

uses System.SysUtils, System.Generics.Defaults, System.Generics.Collections,
  JsonToDelphi.Runtime.JSONName, JsonToDelphi.Runtime.Lists, JsonToDelphi.Runtime.JsonValueHelper;

type
  EJsonMapper = class(Exception);
  TJsonType = JsonToDelphi.Runtime.JsonValueHelper.TJsonType;
...
uses
  ...
  JsonToDelphi.Runtime.ReservedWords;
