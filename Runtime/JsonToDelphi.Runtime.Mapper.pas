unit JsonToDelphi.Runtime.Mapper;
...
uses
  ...
  JsonToDelphi.Runtime.JSONName, JsonToDelphi.Runtime.StubField, JsonToDelphi.Runtime.JsonValueHelper;
...
uses
  ...
  JsonToDelphi.Runtime.ReservedWords, JsonToDelphi.Runtime.SubTypes;
...
begin
  ...
  try
    ...
    StringList.Add('');
    StringList.Add('uses');
    StringList.Add('  JsonToDelphi.Runtime.DTO, System.Generics.Collections, REST.Json.Types;');
    StringList.Add('');
    StringList.Add('{$M+}');
    StringList.Add('');
    StringList.Add('type');
...
begin
  ...
  try
    ...
    Buffer.SaveToFile(TPath.GetDirectoryName(aFileName) + TPath.DirectorySeparatorChar + 'JsonToDelphi.Runtime.DTO.pas');
  finally
    ResourceStream.Free;
    Buffer.Free;
  end;
