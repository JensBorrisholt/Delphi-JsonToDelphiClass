...
begin
  Create(TGeneratorOptions.FromSettings(TSettings.Instance));
end;

constructor TJsonToDelphiGenerator.Create(const AOptions: TGeneratorOptions);
begin
  inherited Create;
  FOptions := AOptions;
