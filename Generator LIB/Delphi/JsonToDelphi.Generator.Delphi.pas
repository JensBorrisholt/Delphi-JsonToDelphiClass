unit JsonToDelphi.Generator.Delphi;

interface

uses
  JsonToDelphi.Generator.Core.Model, JsonToDelphi.Generator.Delphi.Settings;
...
uses
  ...
  JsonToDelphi.Generator.Core.Builder, JsonToDelphi.Generator.Delphi.Writer;
