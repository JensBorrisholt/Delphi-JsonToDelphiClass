...
type
  ...
  public
    constructor CreateAt(const AMessage, AJsonPath: string;
      const APosition, ASelectionLength: Integer);
...
constructor EJsonGenerator.CreateAt(const AMessage, AJsonPath: string;
  const APosition, ASelectionLength: Integer);
begin
